...
<body style="background-color: #f8f8f8">
        ...
        <div class="container" style="height: 5px">
            ...
            <li class="nav-item" class="active"><a class="navbar-text" href="${pageContext.request.contextPath}/orgs"><b>Organizations</b></a>
            </li>
        ...
        <div class='row'>
        <div class='col-lg-5'>
            <h3 class="font-weight-bold text-uppercase" style="text-align:center;">Organizations</h3><br>
            <table id='organizationTable' class='table table-hover' style="text-align: center">
            ...
            <c:forEach var="currentOrganizationList" items="${orgList}">
            <tr>
            <td>
            <a href="orgInfo?organizationId=${currentOrganizationList.id}">
            <c:out value="${currentOrganizationList.name}"/>
            </a>
            </td>
            <td>
            <a href="displayEditOrganization?organizationId=${currentOrganizationList.id}">
            Edit
            </a>
            </td>
            <td>
            <a href="deleteOrganization?organizationId=${currentOrganizationList.id}">
            Delete
            </a>
            </td>
            </tr>
        ...
        <div class='col-lg-6'>
            <h3 class="font-weight-bold text-uppercase" style="text-align:center;">ADD Organization</h3><br>
        ...
        <div class='form-group'>
            <label for='phoneNumber' class='col-lg-3 control-label'>Phone #: </label>
        <div class='col-lg-6'>
            <input type='text' class='form-control' name='phoneNumber' Placeholder='Phone #'/>
        </div>
        </div>
        <div class="form-group">
            <label for="superHVIdList" class="col-lg-3 control-label">Super H/V:</label>
        <div class="col-lg-6">
            <select id="superHVIdList"
                  name="superHVIdList"
              multiple="multiple"
                 class="form-control">
