...
<body style="background-color: #f9f9f9">
        ...
        <div style="height: 40px;float: left" ;width:100%>
            <p class="nav-item"><a class="navbar-text" style="width: 100%; line-height: 0px;margin-top: 12px" 
                href="${pageContext.request.contextPath}/orgs"><b>Go Back To Organizations</b></a></p>
        </div>
        </nav>
        <div class="container">
        <div id="header" style="text-align:center;">
            ...
            <h3 class="font-weight-bold text-uppercase text-muted">Organization Information</h3>      
            ...
            <b>Phone #: </b>
            <c:out value="${organization.phoneNumber}"/><br>
            <b>Super H/V: </b>
