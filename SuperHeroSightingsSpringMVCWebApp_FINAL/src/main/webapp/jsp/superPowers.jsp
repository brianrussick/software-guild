...
<body style="background-color: #f9f9f9">
        ...
        <div class="container" style="height: 5px">
            ...
            <li class="nav-item" class="active"><a class="navbar-text" class="nav-link" href="${pageContext.request.contextPath}/superPowers"><b>Super Powers</b></a>
            </li>
        ...
        <div class='row'>
        <div class='col-lg-5'>
            <h3 class="font-weight-bold text-uppercase" style="text-align:center;">Super Powers</h3><br>
            <table id='powerTable' class='table table-hover' style="text-align: center">
            ...
            <tr>
            <td>
            <a href="superPowerInfo?powerId=${currentSuperPower.id}">
            <c:out value="${currentSuperPower.name}"/>
            </a>
            </td>
            <td>
            <a href="displayEditPower?powerId=${currentSuperPower.id}">
            Edit
            </a>
            </td>
            <td>
            <a href="deletePower?powerId=${currentSuperPower.id}">
            Delete
            </a>
            </td>
            </tr>
        ...
        <div class='col-lg-6'>
            <h3 class="font-weight-bold text-uppercase" style="text-align:center;">Add Super Powers</h3><br>
