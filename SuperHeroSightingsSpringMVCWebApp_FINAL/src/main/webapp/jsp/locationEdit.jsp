...
<body style="background-color: #f9f9f9">
        ...
        <div id="header" style="text-align:center;">
            ...
            <h3 class="font-weight-bold text-uppercase text-muted">Edit Location</h3>
            <br>
            <sf:form class="form-horizontal" role="form" modelAttribute="location" action="locationEdit" method="POST">
        ...
        <div class="form-group">
            <label for="latitude" class="col-lg-1 control">Latitude: </label>
        <div class="col-lg-3">
        ...
        <div class="form-group">
            <label for="longitude" class="col-lg-1 control">Longitude: </label>
        <div class="col-lg-3">
